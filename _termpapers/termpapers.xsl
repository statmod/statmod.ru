   ...
   <html>
     ...
     <body>
      <h1>
        ...
        <p>Для получения информации о кафедре, темах, правилах оформления курсовых работ, получении зачета вступайте в 
        <a href="http://vk.com/sm_sandbox" target = "_blank">группу статмода</a> для 1-2 курсов.</p>

      <h2>
         Список курсовых работ для первого курса
      </h2>
      <p>Список курсовых работ для 1 курса с комментариями находится в 
	<a href="http://vk.com/sm_sandbox" target = "_blank">группе статмода</a>.
	</p>
      
         <h2>Курсовые работы для второго курса, 2017-2018 уч.год</h2>
         <h3> (базовый вариант на 03.09.2017, преподаватель может скорректировать.) </h3>
