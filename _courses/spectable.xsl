...
up-to-date.</p>
		...
		<p><sup>3</sup> Объем курса, по которому нужно сдавать зачет/экзамен (0.5 соответствует семестру занятий по 2 часа в неделю).</p>
...
как (1) и (2). Официальное название таких спецкурсов не включает то, что помещено в скобки.</p>
      </body>
   </html>
</xsl:template>
