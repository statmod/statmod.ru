...
<p>Совсем предварительное расписание (06.08.2018), наверняка будут изменения. Обновляйте страницу (!), чтобы увидеть последний вариант. Сообщайте об ошибках, пожалуйста. 
</p>
<p/>
