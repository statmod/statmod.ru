...
<p>Расписание на 08.02.2023 (поставлены только основные пары, без добавок). Обновляйте страницу (!), чтобы увидеть последний вариант. Сообщайте об ошибках, пожалуйста. 
</p>
<p/>
